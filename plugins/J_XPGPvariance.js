...
// based on difference, modifies modifies the damage between actor and enemy.
// the bigger the difference, the greater the impact between -50% and +50%.
...
// grabs enemy level from notes.
// if zero, or not defined via enemy notes, then no multiplier is applied.
...
// pre-defines levels for enemies.
...
// on setting up an enemy, all levels are defined if existing.
...
// a silly function that says "Actors aren't enemies!" because I'm lazy.
